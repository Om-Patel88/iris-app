...
iris_df = pd.read_csv('https://student-datasets-bucket.s3.ap-south-1.amazonaws.com/whitehat-ds-datasets/iris-species.csv')#iris-species.csv
...
score_lin = svc_model.score(X_train,y_train)
@st.cache()
...
if st.button("Predict"):
	...
	st.write(f"Accuracy score of this model is: {score_lin:.3f}")
